...
export function IncomePageFallback() {
  return (
...
export default function IncomeView({ maxMonth }: { maxMonth: string }) {
  ...
  // The month the page is looking at. `maxMonth` comes from the server, the
  // same clock POST /api/income files income by — deriving it from the browser
  // put the form and the write on opposite sides of a month boundary whenever
  // the two timezones disagreed.
